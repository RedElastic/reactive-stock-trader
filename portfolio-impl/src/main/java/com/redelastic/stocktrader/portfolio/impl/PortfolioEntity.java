...
public class PortfolioEntity extends PersistentEntity<PortfolioCommand, PortfolioEvent, PortfolioState> {
    ...
    private void handleFundEvents(BehaviorBuilder builder) {
        builder.setEventHandler(PortfolioEvent.FundsDebited.class, evt -> ((PortfolioState.Open)state()).update(evt));
        builder.setEventHandler(PortfolioEvent.FundsCredited.class, evt -> ((PortfolioState.Open)state()).update(evt));
    }


    private void handleShareEvents(BehaviorBuilder builder) {
        builder.setEventHandler(PortfolioEvent.SharesCredited.class, evt -> ((PortfolioState.Open)state()).update(evt));
        builder.setEventHandler(PortfolioEvent.SharesDebited.class, evt -> ((PortfolioState.Open)state()).update(evt));
    }
